...
export async function generateMetadata({
  ...
  const description = isSpanish
    ? 'Únete a la open beta y ejecuta Claude Code, Codex, Antigravity CLI, OpenCode, Kimi Code, Grok Build, Cursor Agent, Muse Code, Pi y Devin CLI en paralelo, con visibilidad en tiempo real, notificaciones, historial y Pro gratis.'
    : 'Join the open beta and run Claude Code, Codex, Antigravity CLI, OpenCode, Kimi Code, Grok Build, Cursor Agent, Muse Code, Pi and Devin CLI in parallel with live status, notifications, history and free Pro access.'
