...
export async function generateMetadata({
  ...
  const description = isSpanish
    ? 'CodeAgentSwarm es un entorno de desarrollo agéntico (ADE) para orquestar Claude Code, Codex CLI, Antigravity CLI, OpenCode y Kimi Code en paralelo.'
    : 'CodeAgentSwarm is an Agentic Development Environment (ADE) for orchestrating Claude Code, Codex CLI, Antigravity CLI, OpenCode and Kimi Code in parallel.'
  ...
  return {
    ...
    twitter: {
      ...
      title,
      description: isSpanish
        ? 'Entorno de desarrollo agéntico para orquestar Claude Code, Codex CLI, Antigravity CLI, OpenCode y Kimi Code en paralelo.'
        : 'Agentic Development Environment for orchestrating Claude Code, Codex CLI, Antigravity CLI, OpenCode and Kimi Code in parallel.',
      images: ['/og.png'],
    },
    robots: {
      index: true,
