...
export const guide: Guide = {
  meta: {
    ...
    metaDescription: 'Paseo es un orquestador open source autoalojado que controlas desde el móvil. CodeAgentSwarm es una app de escritorio para macOS y Windows con cinco CLIs de agentes.',
    intro: `Paseo es un orquestador open source que montas tú mismo y que puedes supervisar desde el móvil; CodeAgentSwarm es una app de escritorio para macOS y Windows que ejecuta cinco CLIs de agentes en terminales paralelos. Ahí está la diferencia en una frase, y casi toda la decisión sale de ahí.
  ...
  sections: [
    {
      ...
      content: [
        {
          type: 'paragraph',
          text: 'Paseo es un orquestador open source y autoalojado, con clientes de escritorio, móvil, web y CLI que hablan con un daemon en tu propia máquina; CodeAgentSwarm es una app de escritorio de código cerrado para macOS y Windows que ejecuta cinco CLIs de agentes a la vez en terminales paralelos.',
        },
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      content: [
        {
          type: 'paragraph',
          text: 'CodeAgentSwarm es una app de escritorio para ejecutar y supervisar varios agentes de programación con IA en paralelo. Funciona en macOS y Windows, no es un proveedor de modelos, y pilota las CLIs de agentes que ya tienes instaladas: Claude Code, Codex CLI, Antigravity CLI, OpenCode y Kimi Code.',
        },
        {
          type: 'image',
        ...
        },
        {
          ...
          items: [
            ...
            'Historial buscable de los cinco agentes, con opción de retomar cualquier conversación en un terminal',
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            '<strong>Usas GitHub Copilot o Pi.</strong> Los dos aparecen en su documentación y ninguno está entre las cinco CLIs que movemos.',
