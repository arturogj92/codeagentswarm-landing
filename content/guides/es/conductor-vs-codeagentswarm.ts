...
export const guide: Guide = {
  meta: {
    ...
    metaDescription: 'Conductor es una app solo para Mac con agentes Claude Code, Codex y Cursor en paralelo. CodeAgentSwarm mueve cinco CLIs en macOS y Windows. Comparativa honesta.',
    intro: `Conductor es una app solo para macOS que lanza agentes de Claude Code, Codex y Cursor en paralelo dentro de workspaces aislados; CodeAgentSwarm es una app de escritorio para macOS y Windows que ejecuta cinco CLIs de agentes en terminales paralelos. Misma idea, distinto alcance.
...
Resumen rápido: si tú y tu equipo estáis todos en Mac y queréis una app nativa construida alrededor de revisar y mergear el trabajo de los agentes, Conductor es una elección seria y muy centrada. Si alguien toca Windows, o quieres más de tres CLIs de agentes, CodeAgentSwarm cubre terreno que Conductor no pisa.`,
  ...
  sections: [
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            '<strong>Agentes de Cursor:</strong> uno de sus tres agentes soportados, y no está entre las cinco CLIs que movemos nosotros',
    ...
    },
    {
      ...
      content: [
        {
          type: 'paragraph',
          text: 'CodeAgentSwarm es una app de escritorio para ejecutar y supervisar varios agentes de programación con IA en paralelo. Funciona en macOS y Windows, no es un proveedor de modelos, y pilota las CLIs de agentes que instalas tú: Claude Code, Codex CLI, Antigravity CLI, OpenCode y Kimi Code.',
        },
        {
          type: 'image',
        ...
        },
        {
          ...
          items: [
            ...
            'Historial buscable de los cinco agentes, con opción de retomarlo en un terminal',
      ...
      content: [
        {
          ...
          rows: [
            ...
            [
              ...
              'Claude Code, Codex CLI, Antigravity CLI, OpenCode y Kimi Code',
            ],
            [
            ...
            [
              ...
              'Buscable en los cinco agentes, y se puede retomar cualquiera',
            ],
            [
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            '<strong>Quieres menos piezas.</strong> Tres agentes en lugar de cinco es menos que configurar y mantener al día, y a algunos equipos les compensa.',
          ],
        },
        {
          type: 'callout',
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            '<strong>Quieres cinco CLIs de agentes.</strong> Claude Code, Codex CLI, Antigravity CLI, OpenCode y Kimi Code, mezclados entre terminales. Las tres últimas no están entre los agentes que documenta Conductor.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Conductor soporta Claude Code, Codex y Cursor, según la FAQ de su propia web, donde además invitan a escribirles si echas en falta otro. CodeAgentSwarm soporta cinco CLIs: Claude Code, Codex CLI, Antigravity CLI, OpenCode y Kimi Code. Así que Conductor es el único de los dos que ejecuta agentes de Cursor, y CodeAgentSwarm es el único que ejecuta Antigravity CLI, OpenCode y Kimi Code.',
    },
    {
