...
export const guide: Guide = {
  meta: {
    ...
    metaTitle: 'Notificaciones de Claude Code: entérate cuando termina (2026)',
    metaDescription: 'Alertas de escritorio en el momento en que Claude Code termina o necesita tu atención. Deja de vigilar el terminal: configúralo en minutos y recupera tu foco.',
