  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: 'paragraph',
          text: 'Running several sessions like this is what people mean by a <a href="/en/guides/claude-code-agent-swarm" class="text-neon-cyan hover:text-neon-purple transition-colors">Claude Code agent swarm</a>, and that guide covers how it differs from subagents and how to stop parallel agents overwriting each other. This is not limited to Claude Code either. The same principle applies to <a href="/en/guides/codex-agent-swarm" class="text-neon-cyan hover:text-neon-purple transition-colors">Codex CLI</a> and <a href="/en/guides/antigravity-agent-swarm" class="text-neon-cyan hover:text-neon-purple transition-colors">Antigravity CLI</a>. You can even mix different agents in parallel: the <a href="/en/guides/ai-cli-agent-swarm" class="text-neon-cyan hover:text-neon-purple transition-colors">AI CLI agent swarm</a> guide covers running them together. If you are still deciding which agent to make your main one, the <a href="/en/guides/claude-code-vs-cursor-vs-codex" class="text-neon-cyan hover:text-neon-purple transition-colors">Claude Code vs Cursor vs Codex comparison</a> breaks down pricing and strengths. And everything here works the same on Windows - see the <a href="/en/guides/claude-code-on-windows" class="text-neon-cyan hover:text-neon-purple transition-colors">Claude Code on Windows guide</a> for the platform setup.',
        },
        {
          type: 'callout',
          variant: 'info',
