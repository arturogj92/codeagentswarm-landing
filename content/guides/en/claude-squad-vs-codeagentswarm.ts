...
Short version: if you live in the terminal, work over SSH on remote machines and want AGPL open source, Claude Squad fits you better. If you want a desktop window with notifications, cross-agent history, live diffs and six agent vendors in one place, that is what we built.`,
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            'Searchable conversation history across all six agents, with resume from any entry',
      ...
      content: [
        {
          ...
          rows: [
            ...
            ['Supported agents', 'Claude Code, Codex, Gemini, Amp, OpenCode and other local agents such as Aider, set per session', 'Claude Code, Codex CLI, Antigravity CLI, OpenCode, Kimi Code and Grok Build'],
            ...
            ['Conversation history', 'Sessions can be paused and resumed in the app. A searchable history across agents is not documented on their site as of July 26, 2026', 'Searchable history across all six agents, with resume'],
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            '<strong>You want Aider or another local agent.</strong> Its program flag launches any local agent command, which is broader than our fixed list of six.',
          ],
        },
      ],
    },
      ...
      content: [
        {
          ...
          items: [
            ...
            '<strong>You run six vendors.</strong> Claude Code, Codex CLI, Antigravity CLI, OpenCode, Kimi Code and Grok Build are all supported directly, including Antigravity, Kimi and Grok Build, which are not listed among the agents in the Claude Squad README as of July 26, 2026.',
