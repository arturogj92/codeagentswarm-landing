...
Grok Build is xAI's coding CLI (<code>grok</code>), not the Grok chatbot.`,
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        { type: 'paragraph', text: 'Most teams should not migrate every workflow on day one. Use Grok Build with Grok 4.6 for exploratory tasks while Claude Code keeps the critical path, then widen from measured results. CodeAgentSwarm is designed for that mix.' },
      ],
    },
  ],
  faq: [
