    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'list',
          items: [
            'Open source under Apache-2.0, with roughly 27,900 stars on GitHub (27,907 on August 25, 2026), the largest community of any tool in this comparison',
        ...
        },
        {
          type: 'callout',
          variant: 'warning',
          content: 'We are stating dates, not delivering a verdict. Apache-2.0 code with 27,900 stars does not evaporate, and community-maintained projects can outlive their companies. Read the announcement, check the repository activity yourself, and decide what that means for the way your team works.',
        },
      ],
    },
    {
      ...
      content: [
        {
          ...
          items: [
            ...
            '<strong>You use Antigravity CLI or Kimi Code.</strong> Neither is listed among the agents in the Vibe Kanban README as of August 25, 2026. Both are first-class here, alongside Claude Code, Codex CLI and OpenCode.',
  ...
  faq: [
    {
      ...
      answer: 'Yes. Vibe Kanban is published at github.com/BloopAI/vibe-kanban under the Apache-2.0 license, with roughly 27,900 stars (27,907 when verified on August 25, 2026), the largest community of any tool compared here. CodeAgentSwarm is closed source with no public application repository.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Neither is listed among the coding agents in the Vibe Kanban README as of August 25, 2026, which names Claude Code, Codex, Gemini CLI, GitHub Copilot, Amp, Cursor, OpenCode, Droid, CCR and Qwen Code. CodeAgentSwarm supports Antigravity CLI and Kimi Code directly, along with Claude Code, Codex CLI and OpenCode.',
    },
  ],
}
