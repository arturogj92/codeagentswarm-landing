...
opencode`,
        ...
        {
          type: 'paragraph',
          text: 'opencode is SST\'s open-source terminal agent. For current commands, check the <a href="https://opencode.ai" target="_blank" rel="noopener noreferrer" class="text-neon-cyan hover:text-neon-purple transition-colors">official opencode site</a>. Compare the setup with <a href="/en/guides/claude-code-on-windows" class="text-neon-cyan hover:text-neon-purple transition-colors">Claude Code</a>, <a href="/en/guides/codex-cli-on-windows" class="text-neon-cyan hover:text-neon-purple transition-colors">Codex CLI</a>, <a href="/en/guides/antigravity-cli-on-windows" class="text-neon-cyan hover:text-neon-purple transition-colors">Antigravity CLI</a> or <a href="/en/guides/cursor-cli-on-windows" class="text-neon-cyan hover:text-neon-purple transition-colors">Cursor CLI on Windows</a>.',
        },
      ],
    },
    {
