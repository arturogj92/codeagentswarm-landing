  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          rows: [
            ...
            [
              ...
              'Claude Code, Codex, Gemini and arbitrary local commands such as Aider',
              'Yes, AGPL-3.0',
            ],
            [
              'Nimbalyst',
            ...
            [
              ...
              'No public repo',
              'No public repo',
              'macOS app for local work; managed cloud workspaces; iOS coming soon',
        ...
        {
          type: 'paragraph',
          text: 'Some cells deliberately say "not documented on their site as of August 25, 2026" instead of "no". We are not going to claim a tool lacks Linux support or a mobile client because we could not find it in five minutes. Absent from the docs is a different statement from absent from the product, and the difference matters when what you are reading is meant to be quotable.',
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            'Four agents per their docs as of August 25, 2026, so Antigravity CLI and Kimi Code users are not covered',
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            'Supported platforms are not documented on their site as of August 25, 2026',
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: 'paragraph',
          text: 'Conductor is proprietary software with a macOS app and managed cloud sandboxes for Claude Code, Codex, Cursor and OpenCode. Pro adds cloud workspaces that keep running after the app closes, multiplayer collaboration and a beta HTTP API; pricing starts at $0 locally and $50/month for Pro. There is no Windows desktop build or public repository. Full comparison in <a href="/en/guides/conductor-vs-codeagentswarm" class="text-neon-cyan hover:text-neon-purple transition-colors">Conductor vs CodeAgentSwarm</a>.',
        },
        {
          type: 'heading',
          level: 3,
        ...
        {
          type: 'paragraph',
          text: 'Claude Squad manages multiple AI terminal agents such as Claude Code, Codex, Gemini and Aider as tmux sessions, and can launch an arbitrary local command. It is AGPL-3.0, had about 8,400 stars on August 25, 2026 and its last public commit was August 20, 2026. There is no GUI, which is a feature if you want to run it on a remote box over SSH and a problem if you wanted diffs and notifications on a desktop. For terminal purists it is the most natural fit here. We compare the two approaches in <a href="/en/guides/claude-squad-vs-codeagentswarm" class="text-neon-cyan hover:text-neon-purple transition-colors">Claude Squad vs CodeAgentSwarm</a>.',
        },
        {
          type: 'heading',
          level: 3,
