...
export const guide: Guide = {
  meta: {
    ...
    metaDescription: 'T3 Code is an open source control plane that ends in a one-click PR. CodeAgentSwarm is a supervision workspace for five agent CLIs. Honest 2026 comparison.',
...
Short version: pick T3 Code if open source, Linux support and a fast path from diff to pull request matter most. Pick CodeAgentSwarm if you run agents from five different vendors and need notifications, history and a task board to keep track of them.`,
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            '<strong>You want one searchable history across vendors.</strong> Conversations from all five agents are stored, searchable and resumable in one place instead of five different formats.',
