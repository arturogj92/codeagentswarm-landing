...
test('uses the product feature that matches the guide intent', () => {
  assert.equal(pickGuideVideo('multiple-claude-code-accounts'), 'terminals-list.mp4')
  assert.equal(pickGuideVideo('varias-cuentas-claude-code-codex'), 'terminals-list.mp4')
