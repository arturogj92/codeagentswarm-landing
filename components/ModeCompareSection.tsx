 ...
 * lands on the page. Unlike the simulator it does NOT pull in xterm — the
 * terminal half is static markup — so it is cheap enough to keep on phones,
 * where a drag comparison is if anything more natural than on a mouse.
 */
