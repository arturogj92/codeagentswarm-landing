      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        >
          <a
            ...
            onClick={() => {
              if (typeof window !== 'undefined') {
                window.umami?.track('discord_join_home', { placement: 'header' })
              }
            }}
          ...
          >
            <svg className="w-5 h-5 text-white/70 group-hover:text-neon-cyan transition-colors" viewBox="0 0 24 24" fill="currentColor">
          ...
          >
            <nav className="flex flex-col p-6 gap-4">
              ...
              <a
                ...
                onClick={() => {
                  if (typeof window !== 'undefined') {
                    window.umami?.track('discord_join_home', { placement: 'mobile_menu' })
                  }
                }}
              >
